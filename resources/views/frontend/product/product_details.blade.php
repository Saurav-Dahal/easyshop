                        ...
                        <div class="col-xs-12 col-sm-6 col-md-5 gallery-holder">
                            <div class="product-item-holder size-big single-product-gallery small-gallery">
                                <div id="owl-single-product">
                                    <div class="single-product-gallery-item" id="slider{{$product->product_thumbnail}}">
                                        <a data-lightbox="image-1" data-title="Gallery" href="{{url($product->product_thumbnail)}}">
                                ...
                                <div class="single-product-gallery-thumbs gallery-thumbs">
                                    <div id="owl-single-product-thumbnails">
                                        <div class="item">
                                            <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1" href="#slider{{$product->product_thumbnail}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="price-box">
                                                ...
                                                <span class="price-strike">{{$product->discount_price == NULL || $product->discount_price == $product->selling_price ? ' ' : '$'.$product->selling_price}} </span>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="description" class="tab-pane in active">
                                    <div class="product-tab">
                                        <p class="text">{{strip_tags($product->long_description)}}</p>
                                    </div>	
                                </div><!-- /.tab-pane -->
