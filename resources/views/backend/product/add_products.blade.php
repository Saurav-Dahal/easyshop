                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="product_name" id="product_name" class="form-control" > <div class="help-block"></div>
                                                            @error('product_name')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="product_code" id="product_code" class="form-control" > <div class="help-block"></div>
                                                            @error('product_code')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="row">	
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                        <input type="text" name="product_tags" id="product_tags" class="form-control" value="example, tags" data-role="tagsinput" placeholder="add tags" style="display: none;">
                                                            @error('product_tags')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                        <input type="text" name="product_size" id="product_size" class="form-control" value="Medium, Large" data-role="tagsinput" placeholder="add sizes" style="display: none;">
                                                            @error('product_size')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                        <input type="text" name="product_color" id="product_color" class="form-control" value="White, black" data-role="tagsinput" placeholder="add colors" style="display: none;">
                                                            @error('product_color')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="row">	
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="product_qty" id="product_qty" class="form-control" > <div class="help-block"></div>
                                                            @error('product_qty')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="selling_price" id="selling_price" class="form-control" > <div class="help-block"></div>
                                                            @error('selling_price')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="discount_price" id="discount_price" class="form-control" > <div class="help-block"></div>
                                            ...
                                            <div class="row">	
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <textarea id="editor1" name="long_description" rows="5" cols="60" placeholder="Enter Text Here..."></textarea>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
							                                <textarea name="short_description" rows="20" cols="10" class="form-control" placeholder="Enter Short Description"></textarea>
                                            ...
                                            <div class="row">	
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="checkbox" id="hot_deals" name="hot_deals" class="filled-in chk-col-primary" value="1">
                                                        <label for="hot_deals">Hot Deals</label> 
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="hidden" name="featured" value="0">
                                                        <input type="checkbox" id="featured" name="featured" class="filled-in chk-col-primary" value="1">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="checkbox" id="special_offer" name="special_offer" class="filled-in chk-col-primary" value="1">
                                                        <label for="special_offer">Special Offer</label> 
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="hidden" name="special_deals" value="0">
                                                        <input type="checkbox" id="special_deals" name="special_deals" class="filled-in chk-col-primary" value="1">
