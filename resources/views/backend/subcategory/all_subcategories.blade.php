                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('subcategory/delete/'.$item->id)}}" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete it?')" id="delete"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
